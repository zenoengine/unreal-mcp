...
async def get_widget_info(
    blueprint_path: Annotated[str, Field(description="Content-browser path to the WidgetBlueprint (e.g. '/Game/UI/WBP_HUD').")]
) -> dict:
    return await send_unreal_action(UMG_ACTIONS_MODULE, {"blueprint_path": blueprint_path})
...
async def add_widget(
    blueprint_path: Annotated[str, Field(description="Content path to the WidgetBlueprint.")],
...
async def get_widget_property(
    ...
    property_name: Annotated[str, Field(description="Name of the property (snake_case UE Python name, e.g. 'text', 'font', 'color_and_opacity').")]
) -> dict:
    return await send_unreal_action(UMG_ACTIONS_MODULE, {
        "blueprint_path": blueprint_path,
        "widget_name": widget_name,
...
async def set_widget_property(
    blueprint_path: Annotated[str, Field(description="Content path to the WidgetBlueprint.")],
    widget_name: Annotated[str, Field(description="Name of the target widget.")],
    property_name: Annotated[str, Field(description="Property name (e.g. 'text', 'is_enabled', 'tool_tip_text').")],
