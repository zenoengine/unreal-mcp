...
def ue_umg_get_widget_info(blueprint_path: str = None) -> str:
    """Returns JSON describing the widget tree of a WidgetBlueprint."""
    if not blueprint_path:
        return json.dumps({"success": False, "message": "Required parameter 'blueprint_path' is missing."})
    try:
        bp = unreal.EditorAssetLibrary.load_asset(blueprint_path)
        if bp is None:
            return json.dumps({"success": False, "message": f"Asset not found: '{blueprint_path}'."})
        return unreal.MCPythonHelper.umg_get_widget_info(bp)
    except Exception as e:
        return json.dumps({"success": False, "message": str(e), "traceback": traceback.format_exc()})


def ue_umg_add_widget(blueprint_path: str = None, widget_type: str = None,
...
def ue_umg_remove_widget(blueprint_path: str = None, widget_name: str = None) -> str:
...
def ue_umg_set_slot_layout(blueprint_path: str = None, widget_name: str = None,
...
def ue_umg_set_text_style(blueprint_path: str = None, widget_name: str = None,
                           font_size: int = 24,
...
def ue_umg_get_widget_property(blueprint_path: str = None, widget_name: str = None,
...
def ue_umg_set_widget_property(blueprint_path: str = None, widget_name: str = None,
